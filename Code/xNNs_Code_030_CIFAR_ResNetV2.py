...
# NOTES
#
#    1. The training configuration needs modification
#       - Likely more iterations per step
#       - Play around some with the batch size and learning rates too
#       - Maybe less block repeats per level in the model too
#
################################################################################
...
# create and compile model
model = create_model(DATA_CROP_ROWS, DATA_CROP_COLS, DATA_CHANNELS, MODEL_LEVEL_0_BLOCKS, MODEL_LEVEL_1_BLOCKS, MODEL_LEVEL_2_BLOCKS, DATA_NUM_CLASSES, TRAINING_LR_INITIAL)
